...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['confirm_delete'])) {
  ...
  $deleteSql = "DELETE FROM companies WHERE email='$email'";
        ...
        <div class="card mb-5" style="border-radius: .5rem;">
          <div class="row g-0">
            <div class="col-md-4 gradient-custom text-center text-white" style="border-top-left-radius: .5rem; border-bottom-left-radius: .5rem;">
              <img src="company.png"alt="Avatar" class="img-fluid my-5" style="width: 250px; height:250px ;" />
            ...
            <div class="col-md-8">
              <div class="card-body p-4">
                ...
                <a href="company-edit-profile.php" class="btn btn-light btn-sm">Edit About section</a>

                <form action="company-profile-index.php" method="POST" class="ml-2">
