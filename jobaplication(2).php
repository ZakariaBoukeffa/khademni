...
class JobApplication {
    ...
    public function __construct($dbhost, $dbuser, $dbpass, $dbname) {
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['apply_job'])) {
            ...
            $this->insertApplication($job_id, $fname, $lname, $email, $resume, $user_location, $phone_num, $description);
        }
    }
    
    private function insertApplication($job_id, $fname, $lname, $email, $resume, $user_location, $phone_num, $description) {
        // Sanitize input
        ...
        $resume = $this->conn->real_escape_string($resume);
        $user_location = $this->conn->real_escape_string($user_location);
        $phone_num = $this->conn->real_escape_string($phone_num);
...
$jobApplication = new JobApplication($dbhost, $dbuser, $dbpass, $dbname);

// Close the database connection
$jobApplication->closeConnection();
?>
</main>
	 <!-- ======= Footer ======= -->
	 <footer id="footer">
